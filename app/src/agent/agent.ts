...
- ALWAYS include a "Block Explorer" row (NOT "TX Hash") when a transaction succeeds. ALWAYS make it a clickable markdown link using the explorerUrl from the tool result.
...
| Condition | ETH > $4,000 |
| Chain | Arc Testnet |
| Block Explorer | [View on ArcScan](https://testnet.arcscan.app/tx/0xabc123def456) |
...
- End EVERY response with the privacy summary. For transfers and payroll, include a "Proof of Income" link.
